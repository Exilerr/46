				...
				<div class="col-md-6 col-xs-12">
					<div class="footer">
						...
						<ul class="footer-links">
							...
							<li><a href="#"><i class="fa fa-envelope-o"></i>fpt.edu@gmail.com</a></li>
						</ul>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-12 text-center">
						...
						<span class="copyright">
							...
							<b>Designed with all <i class="fa fa-heart-o"></i> by <a href="https://fb.com/ngochoang.098" target="_blank">Ngọc Hoàng</a></b>
						</span>
					</div>
				</div>
			</div>
